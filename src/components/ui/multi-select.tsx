...
const multiSelectVariants = cva(
    "m-1 transition duration-300 delay-150 ease-in-out",
    {
        variants: {
            variant: {
                default:
            ...
            >
                <PopoverTrigger asChild>
                    <Button
                        ...
                        variant={"secondary"}
                        className={cn(
                            "flex w-full p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-transparent hover:bg-inherit",
                            className
                        )}
                    >
                        {selectedValues.length > 0 ? (
                            <div className="flex justify-between items-center w-full">
                                <div className="flex items-center max-w-[calc(100%-4rem)] overflow-x-auto no-scrollbar">
