...
const navigationMenuTriggerStyle = cva(
  "inline-flex justify-center items-center hover:bg-background focus:bg-background data-[active]:bg-background data-[state=open]:bg-background disabled:opacity-50 px-4 py-2 rounded-md w-max h-9 font-medium text-sm hover:text-accent-foreground focus:text-accent-foreground transition-colors disabled:pointer-events-none group focus:outline-none"
)
